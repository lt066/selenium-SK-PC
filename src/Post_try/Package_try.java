...
public class Package_try {
	  ...
	  public String try_title = "套餐活动-12/01-紫金-";
	  public String order_url = "http://www.taobao.com";
	  public String goodsName1 = "套餐1-1111";
	  public String goodsName2 = "套餐2-2222";
	  public String goodsName3 = "套餐3-3333";
	  ...
	  public void testWebtest1() throws Exception {
	    ...
	    for(;j<=try_number;j++)
	    {
	    	...
	    	if(is_change_type == 0)
	    	{
		         ...
		         driver.findElement(By.id("rdTypePackage")).click();
		         driver.findElement(By.id("buyRequire")).sendKeys("随意试用品信息");
		         driver.findElement(By.id("goodsName1")).sendKeys(goodsName1); 
		         driver.findElement(By.id("goodsName2")).sendKeys(goodsName2); 
		         driver.findElement(By.id("goodsName3")).sendKeys(goodsName3); 
	    	}
