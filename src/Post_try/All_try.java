	  ...
	  public void post_qr_order()
	  {
		     ...
		     g_try.is_qr_order = true;
			  if(!g_try.joided_buyer_limits)
				  g_try.try_title = "二维码活动-12/01-品牌-";
			  else
				  g_try.try_title = "sk4二维码活动-限制试客";
...
//				e.printStackTrace();
	  ...
	  public void post_no_qr_order()
	  {
		     ...
		     g_try.is_qr_order = false;
			  if(!g_try.joided_buyer_limits)
				  g_try.try_title ="普通活-12/01-品牌-";
			  else
				  g_try.try_title = "sk4普通活动-限制试客";
		     g_try.order_url = "http://www.taobao.com";
		     try {
				g_try.testWebtest1();
			} catch (Exception e) {
...
//				e.printStackTrace();
	  ...
	  public void post_cell_try()
	  {
		  ...
		  if(!ce_try.joided_buyer_limits)
		      ce_try.try_title = "手淘下单活动-12/01-品牌-";
		  else
			  ce_try.try_title = "sk4手淘下单活动-限制试客";
	  ...
	  public void post_view_try()
	  {
		  ...
		  if(!view_try.joided_buyer_limits)
		      view_try.try_title ="答案试用活动-12/01-品牌-";
		  else
			  view_try.try_title = "sk4答案试用活动-限制试客";
	  ...
	  public void post_pac_try()
	  {
		  ...
		  if(!pa_try.joided_buyer_limits)
			  pa_try.try_title = "套餐活动-12/01-品牌-";
		  else
			  pa_try.try_title = "sk4套餐活动-限制试客";
	  ...
	  public void post_search_try()
	  {
		  ...
		  if(!search_try.joided_buyer_limits)
			  search_try.try_title = "普通搜索活动-12/01-品牌-";
		  else
			  search_try.try_title = "sk4普通搜索活动-限制试客";
	  ...
	  public void post_app_try()
	  {
		  ...
		  if(!app_try.joided_buyer_limits)
			  app_try.try_title ="app活动-12/01-紫金-";
		  else
			  app_try.try_title = "sk4-app活动-限制试客";
		  app_try.step[0] = "选择地毯";
	  ...
	  public void post_com_try()
	  {
		  ...
		  if(!command_try.joided_buyer_limits)
			  command_try.try_title = "口令活动-12/01-紫金-";
		  else
			  command_try.try_title = "sk4口令活动-限制试客";
	  ...
	  public void post_taoSearch_try()
	  {
		  ...
		  if(!taoSearch_try.joided_buyer_limits)
			  taoSearch_try.try_title = "手淘搜索活动-12/01-紫金-";
		  else
			  taoSearch_try.try_title = "sk4手淘搜索活动-限制试客";
